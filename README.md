...
At the end of simulation, program prints statistics of each age group as well as of the whole population of agents. Moreover, it saves graphs which might be useful for the further analysis. Example output plots are presented below.
