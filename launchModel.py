...
def showSettings() :
    clear()
    print_error_message()
    print('Type word in parentheses to change followed by = and the value you wish to change it to ')
    ...
    print("none, few, half, most or all")
    print("------------------------------")
    ...
    print("none, minimal, moderate or severe")
    print("------------------------------")
